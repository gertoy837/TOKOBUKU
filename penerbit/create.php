                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kota" required class="form-control" id="exampleInputEmail1">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Telepon</label>
                                <input type="number" name="telepon" required class="form-control" id="exampleInputEmail1">
                            </div>
                            <div class="mb-3">
